...
import { AboutHeroData } from "@/cms/about/types";
...
export function AboutHero({ data }: { data: AboutHeroData }) {
  return (
    <section className="relative w-full min-h-[70vh] flex flex-col justify-center overflow-hidden bg-background">
      {/* Background System */}
      ...
      <HeroLayout alignment="center" className="pt-20">
        <motion.div
          ...
          <motion.h1
            ...
            className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tighter text-foreground mb-8 leading-tight"
          >
            {data.headline}
          </motion.h1>
